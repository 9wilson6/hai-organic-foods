    ...
    <div className="relative">
      ...
      >
        ...
        <div className="flex flex-col py-3 pb-5 tet-sm text-neutral-600 border-b-[0.5px]">
          <span
            className={`py-3 px-5 ${
              selectedCategories.includes("Fruits") ? "bg-purple-50" : ""
            }`}
          ...
          <span
            className={`py-3 px-5 ${
              selectedCategories.includes("Cereals") ? "bg-purple-50" : ""
            }`}
            onClick={() => toggleCategory("Cereals")}
          >
            Cereals
          </span>
          <span
            className={`py-3 px-5 ${
              selectedCategories.includes("Vegetables") ? "bg-purple-50" : ""
            }`}
          ...
          <span
            className={`py-3 px-5 ${
              selectedCategories.includes("Juices") ? "bg-purple-50" : ""
            }`}
            onClick={() => toggleCategory("Juices")}
          >
            Juices
          </span>
        </div>
